...
if(promf >= 4){
    document.getElementById('promfinal').textContent = "Felicidades! Aprobaste con: " + promf.toFixed(1)
} else{
    document.getElementById('promfinal').textContent = "Lástima! Tu promedio final fue: " + promf.toFixed(1)
}
